...
async function loadFacts() {
  const response = await fetch(
    "https://spyxpzbsoivpadnuksog.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNweXhwemJzb2l2cGFkbnVrc29nIiwicm9sZSI6ImFub24iLCJpYXQiOjE2ODcyNzE5MzAsImV4cCI6MjAwMjg0NzkzMH0.xgWdis01QgpNmxyyefTIdt0icgHP2oIyw9ugs7esPnk",
      },
    }
  );
